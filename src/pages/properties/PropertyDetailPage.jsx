...
import FeedbackSection from '../../components/properties/detail/FeedbackSection';
      ...
      <Content className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        <div className="mb-4">
          <Button
            ...
            className="flex items-center gap-2 hover:bg-gray-50 mb-4"
          >
            Quay lại danh sách
          </Button>
        </div>
