  ...
  return (
    <Layout className="min-h-screen">
      ...
      <Content className="flex-1" style={{ backgroundColor: '#FFFFFF', minHeight: '100vh' }}>
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-h-screen pt-10 my-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {/* Left: 5/12 */}
          <div className="col-span-1 lg:col-span-4 bg-white rounded-xl shadow-md p-6 border border-gray-400">
            ...
            <div className='flex flex-col items-center justify-center'>
              ...
              <span className='font-bold text-3xl text-center mt-3'>{profile?.fullName}</span>
              <span className='text-xl text-center'>{profile?.phone}</span>
            </div>
